include("tandem_network.jl")

function sim_net_sojourn(net::NetworkParameters; max_time = Float64(10^6), warm_up_time = 10^4, seed::Int64 = 42)
    ...
    """
    function simulate_sojourn(init_state::State, init_timed_event::Vector{TimedEvent}
                        ; 
        ...
        global new_job = 0
        global total_jobs = 0 
        global dict_jobs = Dict{Int, boolean}()
        for i in 1:10^4
            dict_jobs[i] = false
        end 
